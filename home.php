...
<style>
    ...
    .container-fluid {
    padding-left: 0; /* Remove padding from the container for a full-width effect */
    padding-right: 0;
}

.card.user-card {
    width: calc(100% - 20px); /* Make the card take the full width minus margins */
    margin: 10px auto; /* Center the card with equal margins */
    text-align: center;
    padding: 20px;
    background: rgba(255, 255, 255, 0.7); /* Matte glass effect */
    backdrop-filter: blur(10px);
